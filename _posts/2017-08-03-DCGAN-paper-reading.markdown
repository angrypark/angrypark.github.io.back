---
title: "DCGAN 논문 이해하기"
excerpt: DCGAN 논문 처음부터 끝까지 차근차근 이해하기
...
- PyTorch
---
![image](/images/2017-08-03-DCGAN-paper-reading/background.jpg)
...
---
## GAN Review
![gan-workflow](/images/2017-08-03-DCGAN-paper-reading/gan-workflow.jpg)
...
#### 기존 GAN Architecture
기존 GAN은 자세히 살펴보면 다음과 같은 아주 간단하게 fully-connected로 연결되어 있다. ![gan-architecture](/images/2017-08-03-DCGAN-paper-reading/gan-architecture.png)

#### CNN Architecture
CNN은 이러한 fully-connected 구조 대신에 convolution, pooling, padding을 활용하여 레이어를 구성한다.

![cnn-architecture](/images/2017-08-03-DCGAN-paper-reading/cnn-architecture.png)

#### DCGAN Architecture
DCGAN은 결국, 기존 GAN에 존재했던 fully-connected구조의 대부분을 CNN 구조로 대체한 것인데, 앞서 언급했던 것처럼 엄청난 시도들 끝에 다음과 같이 구조를 결정하게 되었다.

![architecture-guidelines](/images/2017-08-03-DCGAN-paper-reading/architecture-guidelines.png)
...
![padding-strides](/images/2017-08-03-DCGAN-paper-reading/padding_strides.gif)

---

**- Fractionally-strided convolutions?**
![padding-strides-transposed](/images/2017-08-03-DCGAN-paper-reading/padding_strides_transposed.gif)
...
![generator-model](/images/2017-08-03-DCGAN-paper-reading/generator-model.png)
...
## Visualization
#### Generated bedrooms
![Visualization](/images/2017-08-03-DCGAN-paper-reading/visualization-1.png)

---

#### Walking in the latent space
![Visualization](/images/2017-08-03-DCGAN-paper-reading/visualization-2.png)
...
![Visualization](/images/2017-08-03-DCGAN-paper-reading/visualization-3.png)

---

#### Applying arithmetic in the input space
![Visualization](/images/2017-08-03-DCGAN-paper-reading/visualization-4.png)
